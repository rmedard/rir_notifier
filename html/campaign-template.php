        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                ...
                <tr>
                  <td valign="top">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:384px;" width="100%" class="columnContainer">
                      <tr>
                        <td valign="top">
                          <div class="preheader_leftcol_content">
          ...
          <tr>
            <td valign="top" id="templateHeader">
              ...
              <img src="https://s3.eu-central-1.amazonaws.com/jirbucket/banners/job_in_rwanda_our_partners-02.jpg" style="max-width:564px;" class="templateImage" alt="job_in_rwanda_our_partners-02.jpg">
          ...
          <tr>
            <td valign="top" id="templateBody">
              ...
              <div class="body_content">
                <h1 style="text-align:center;">Rent in Rwanda</h1>
                <h2 style="display:none;">Heading 2</h2>
                <h3>Our latest adverts</h3>
                <h4 style="display:none;">Heading 4</h4>
                <p><strong>Dear user!</strong>
                  <br>Please find the latest adverts that may interest you.</p>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr class="advert">
                    ...
                    <td id="detailsBlockId">
                      <p id="titleId"><a href="#"><?php echo $advert->title ?></a> - Ref: <span>reference</span> - <span>Price</span>
                      </p>
